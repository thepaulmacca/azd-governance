...
> ⚠️ Please consider carefully which Entra ID tenant you will use and read the Terraform documentation carefully about configuring the required elevated privileges. If possible, use a non-production AAD tenant.
